...
public class IBlockEntity {
    ...
    public static final RegistryObject<BlockEntityType<DirtGeneratorBlockEntity>> DIRT_GENERATOR = BLOCK_ENTITY.register("dirt_generator", () -> BlockEntityType.Builder.of(DirtGeneratorBlockEntity::new, IBlocks.DIRT_GENERATOR.get()).build(null));
}
